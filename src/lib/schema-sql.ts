// Auto-generated from prisma/schema.sql — bundled into JS so it is available at runtime on Vercel.
// DO NOT EDIT — regenerate with: bun run scripts/generate-schema-ts.ts
